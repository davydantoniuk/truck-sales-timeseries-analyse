...
par(mfrow = c(1, 2))
acf(ts(data$Sales, frequency = 12), col = 2, lwd = 2, main = "Autokorelacja (ACF)")
pacf(ts(data$Sales, frequency = 12), col = 2, lwd = 2, main = "Cząstkowa Autokorelacja (PACF)")
par(mfrow = c(1, 1))
```
...
plot(train_ts, col = 5, lwd = 4, xlim = x_range, ylim = y_range, 
     main = "Prognoza metodą Holt-Winters", xlab = "Czas", ylab = "Wartości")
lines(forecast_holtwinters$mean, col = 4, lwd = 3)
lines(test_ts, col = 2, lwd = 2,alpha=0.5)
legend("topleft", legend = c("Dane treningowe", "Prognoza", "Dane testowe"), col = c(5, 4, 2), lwd = 2)
```
